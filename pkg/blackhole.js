...
export class Renderer {
     ...
     */
    add_ray_from_click(mouse_x, mouse_y) {
        const ret = wasm.renderer_add_ray_from_click(this.__wbg_ptr, mouse_x, mouse_y);
        if (ret[1]) {
     ...
     */
    buffer_ptr() {
        const ret = wasm.renderer_buffer_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    constructor() {
     ...
     * @param {number} mass
     */
    set_blackhole_mass(mass) {
        const ret = wasm.renderer_set_blackhole_mass(this.__wbg_ptr, mass);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    update() {
        wasm.renderer_update(this.__wbg_ptr);
    }
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_log_a864f18e37ee3da7: function(arg0, arg1) {
